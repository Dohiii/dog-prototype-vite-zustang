...
const CreateNewDog: React.FC = () => {
  ...
  const CreateDog = async (newDogData: IDog) =>
    await axios.post(`/dogs`, newDogData, config);
      ...
      <form>
        <Flex w="400px" direction={"column"} align="center" justify={"center"}>
          ...
          <Select
            ...
            onChange={(e: any) => setTemperament(e.target.value)}
          >
          ...
          <Select
            placeholder="Agresive"
            onChange={(e: any) => setAgressive(e.target.value)}
          >
            <option value={1}>1</option>
            <option value={2}>2</option>
            <option value={3}>3</option>
