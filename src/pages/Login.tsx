      ...
      <Container centerContent h={"93vh"} maxW={"xl"}>
        <form>
          <Flex w="400px" direction={"column"} align="center" justify={"center"}>
            ...
            <Input marginTop={"1rem"} placeholder="Email" size="md" onChange={(event) => setEmail(event.target.value)} />

            <InputGroup marginTop={"1rem"} size="md">
              <Input pr="4.5rem" type={show ? "text" : "password"} placeholder="Enter password" onChange={(event) => setPassword(event.target.value)} />
